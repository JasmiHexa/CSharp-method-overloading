...
public sealed class DiscountService
{
    ...
    public DiscountService(ConsoleLogger logger) => _logger = logger;
    ...
    public decimal ApplyDiscount(Order order)
    {
        ...
        return ApplyDiscount(order.Items.Sum(i => i.UnitPrice * i.Quantity), pct, maxDiscount: 25m);
    }
    ...
    public decimal ApplyDiscount(decimal amount, string couponCode)
    {
        ...
        return ApplyDiscount(amount, pct, maxDiscount: 40m);
    }
    ...
    public decimal ApplyDiscount(decimal amount, decimal percentage, decimal maxDiscount)
    {
        ...
        _logger.Log(LogLevel.Debug, $"Discount applied: {applied:0.00}");
        return applied;
    }
}
